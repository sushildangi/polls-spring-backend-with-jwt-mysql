...
<div class="menu-mobile menu-activated-on-click color-scheme-dark">
	<div class="mm-logo-buttons-w">
		<a class="mm-logo" href="index.html"><img
			src="${contextRoot }/resources/admin/img/logo.png"><span>Clean
				Admin</span></a>
	...
	<div class="menu-and-user">
		<div class="logged-user-w">
			<div class="avatar-w">
				<img alt="" src="${contextRoot }/resources/admin/img/avatar1.jpg">
			</div>
		...
		<ul class="main-menu">
			<li class="has-sub-menu"><a href="index.html"><div
						class="icon-w">
...
<div
	...
	<div class="menu-actions">
		...
		<div
			class="messages-notifications os-dropdown-trigger os-dropdown-position-right">
			...
			<div class="os-dropdown light message-list">
				<ul>
					<li><a href="#"><div class="user-avatar-w">
								<img alt=""
									src="${contextRoot }/resources/admin/img/avatar1.jpg">
							</div>
					...
					<li><a href="#"><div class="user-avatar-w">
								<img alt=""
									src="${contextRoot }/resources/admin/img/avatar2.jpg">
							</div>
							<div class="message-content">
					...
					<li><a href="#"><div class="user-avatar-w">
								<img alt=""
									src="${contextRoot }/resources/admin/img/avatar3.jpg">
							</div>
							<div class="message-content">
					...
					<li><a href="#"><div class="user-avatar-w">
								<img alt=""
									src="${contextRoot }/resources/admin/img/avatar4.jpg">
							</div>
							<div class="message-content">
		...
		<div
			class="top-icon top-settings os-dropdown-trigger os-dropdown-position-right">
	...
	<ul class="main-menu">
		...
		<li class="selected has-sub-menu"><a href="index.html"><div
					class="icon-w">
					<div class="os-icon os-icon-layout"></div>
				</div> <span>Dashboard</span></a>
			...
			<div class="sub-menu-w">
				...
				<div class="sub-menu-i">
					<ul class="sub-menu">
						...
						<li><a href="layouts_menu_side_full_dark.html">Side Menu
								Dark</a></li>
						<li><a href="layouts_menu_side_transparent.html">Side
								Menu Transparent <strong class="badge badge-danger">New</strong>
						</a></li>
						<li><a href="apps_pipeline.html">Side &amp; Top Dark</a></li>
						<li><a href="apps_projects.html">Side &amp; Top</a></li>
						<li><a href="layouts_menu_side_mini.html">Mini Side Menu</a></li>
					...
					<ul class="sub-menu">
						<li><a href="layouts_menu_top_image.html">Top Menu Image
